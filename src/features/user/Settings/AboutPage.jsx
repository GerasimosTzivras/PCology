//This file is responsible for the about info of the user
//accessible with: ../profile/about
...
const AboutPage = ({ pristine, submitting, handleSubmit, updateProfile }) => {
  return (
    <Segment>
      ...
      <p>Συμπλήρωσε την παρακάτω φόρμα, για καλύτερη εμπειρία στο PCology.gr!</p>
